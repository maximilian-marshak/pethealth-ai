...
const s = StyleSheet.create({
  ...
  grid:             { padding: PAD },
  cell:             { borderRadius: 12, overflow: 'hidden', backgroundColor: '#EEF2FF', marginBottom: GAP },
  cellImage:        { width: '100%', height: '100%' },
  cellPlaceholder:  { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: '#F3F4F6' },
