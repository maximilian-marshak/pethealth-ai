...
const makeStyles = (theme) => StyleSheet.create({
  ...
  content:        { padding: 16 },
  progressCard:   { backgroundColor: theme.surface, borderRadius: theme.radii.r14, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: theme.hairline },
  progressText:   { fontSize: 14, fontFamily: theme.font.bold, color: theme.t1, marginBottom: 8 },
  ...
  section:        { backgroundColor: theme.surface, borderRadius: theme.radii.r14, marginBottom: 10, borderWidth: 1, borderColor: theme.hairline, overflow: 'hidden' },
  secHeader:      { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 14, borderBottomWidth: 1, borderBottomColor: theme.hairline },
  secIcon:        { width: 32, height: 32, borderRadius: theme.radii.r10, backgroundColor: theme.accentTint, alignItems: 'center', justifyContent: 'center' },
  secTitle:       { flex: 1, fontSize: 15, fontFamily: theme.font.bold, color: theme.t1 },
