...
const makeStyles = (theme) => StyleSheet.create({
  ...
  petChip:              { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: theme.radii.pill999, backgroundColor: theme.t1 + '14', borderWidth: 1, borderColor: theme.hairline },
...
const makeMStyles = (theme) => StyleSheet.create({
  ...
  chip:        { paddingHorizontal: 16, paddingVertical: 9, borderRadius: theme.radii.pill999, backgroundColor: theme.t1 + '14', borderWidth: 1, borderColor: theme.hairline, marginRight: 8 },
