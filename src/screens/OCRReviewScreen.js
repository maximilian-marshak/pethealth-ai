...
const makeStyles = (theme) => StyleSheet.create({
  ...
  checkHint:      { fontSize: 11, fontWeight: '600', color: theme.warn, backgroundColor: theme.warn + '22', paddingHorizontal: 6, paddingVertical: 1, borderRadius: theme.radii.sm8 },
