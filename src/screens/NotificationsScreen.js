...
const makeStyles = (theme) => StyleSheet.create({
  ...
  markAll:      { fontSize: 14, fontWeight: '600', color: theme.accent },
  content:      { padding: 16 },
  section:      { marginBottom: 18 },
  sectionTitle: { fontSize: 14, fontWeight: '700', color: theme.t3, marginBottom: 8, textTransform: 'uppercase' },
  card:         { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: theme.surface, borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: theme.hairline },
  cardUnread:   { borderColor: theme.accent, backgroundColor: theme.accentTint },
  iconWrap:     { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  type:         { fontSize: 11, fontWeight: '700', color: theme.t4, textTransform: 'uppercase' },
  title:        { fontSize: 15, fontWeight: '600', color: theme.t1, marginTop: 1 },
