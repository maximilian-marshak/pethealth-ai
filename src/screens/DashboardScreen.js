...
const makeStyles = (theme) => StyleSheet.create({
  ...
  switcherAvatar: { width: 52, height: 52, borderRadius: 26, backgroundColor: theme.accentTint, justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  switcherAvatarImg: { width: 52, height: 52, borderRadius: 26 },
  switcherAvatarEmoji: { fontSize: 26 },
  switcherName: { fontSize: 18, fontWeight: '700', color: theme.t1 },
  switcherBreed: { fontSize: 13, color: theme.t2, marginTop: 1 },
  switcherActions: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  bellBtn: { padding: 4, position: 'relative' },
  bellBadge: { position: 'absolute', top: 0, right: 0, minWidth: 16, height: 16, borderRadius: 8, backgroundColor: theme.danger, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 3 },
  bellBadgeText: { color: theme.onAccent, fontSize: 10, fontWeight: '700' },
  ...
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: theme.t1, paddingHorizontal: 20, marginTop: 8, marginBottom: 12 },
  ...
  pawsIconContainer: { width: 48, height: 48, borderRadius: 12, backgroundColor: theme.accentTint, justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  ...
  actionText: { fontSize: 12, color: theme.t2, fontWeight: '500' },
});
