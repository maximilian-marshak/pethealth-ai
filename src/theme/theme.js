...
const lightBase = {
  ...
  bgBlobs: [
    { color: '#56B89F', cx: 0.16, cy: 0.10, r: 0.72, opacity: 0.26 }, // мятное — верх-слева, плотнее
    { color: '#EC8C69', cx: 0.92, cy: 0.04, r: 0.55, opacity: 0.18 }, // персиковое — верх-справа, деликатно
    { color: '#4F8DF0', cx: 0.50, cy: 0.96, r: 0.66, opacity: 0.16 }, // голубое — низ, деликатно
  ],
...
const darkBase = {
  ...
  bgBlobs: [
    { color: '#6FCBB2', cx: 0.16, cy: 0.10, r: 0.72, opacity: 0.15 }, // мятное — верх-слева
    { color: '#F2A07B', cx: 0.92, cy: 0.04, r: 0.55, opacity: 0.11 }, // персиковое — верх-справа
    { color: '#6BA1F5', cx: 0.50, cy: 0.96, r: 0.66, opacity: 0.12 }, // голубое — низ
  ],
  surface: '#1E1E28',                            // spec
